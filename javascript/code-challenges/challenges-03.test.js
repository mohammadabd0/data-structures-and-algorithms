...
const typeNum = (arr) => {
  // Solution code here...
  let newtypeNum = arr.filter(item => !isNaN(item));
  return newtypeNum;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newContainsAnd = arr.filter(item => item.includes('and'));
...
const oddValues = (arr) => {
  // Solution code here...
  let newoddValues = arr.filter(valua => valua%2 !== 0);
  return newoddValues;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let notInarr = arr.filter(valua => {
    return !forbiddenValues.includes(valua);
  });
  return notInarr;
};
